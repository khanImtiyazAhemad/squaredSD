angular.module('avaanaController').controller('listalertPopUpCtrl', function(apiService, $scope, $stateParams, $mdDialog, $state, Message,type,$timeout,next_Step,current_Step,Heading,scope) {
